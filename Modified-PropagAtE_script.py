...
# Modified by Steven Sutcliffe
# Allows prophages with no flanking regions to be included using the bacterial MAG mean coverage
...
samfile = ''
bamfile = ''
sortbamfile = "SRR828661_das_check_bin_abundance.gap-1_mm-3.sorted.bam"
fasta = ''
forward = ''
reverse = ''
threads = ''
vibe = "propagate_coordinates"
id = ''
pval = 0.05
pval = 0.050
gaps = 1
...
ratio_cutoff = 1.65
termsplit = ''
###Making a split for the bin as well:
binsplit = '_k119_'
outfile = "test.tsv"
outpath = "Test_Bowtie"
clean = False
